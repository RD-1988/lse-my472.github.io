...
Here we are collecting 30 seconds of tweets. And once again, to open the tweets in R...
```{r}
...
```{r, eval=FALSE}
library(ROAuth)
my_oauth <- list(consumer_key = "9gAGsUugGvw5IYxNlyexIi1WQ",
   consumer_secret = "r40Hf7iAmIS8C80zGDPJQFTa1YUlmPyCLpabMoTjFtSFotJ1cs",
   access_token="1195010810503991296-exCI7OHQvLfMRtqnvEWtkjyAeFOW0t",
   access_token_secret = "7mBWnarHlng5Xv4XJ7pFfaRbc0tbYcY5kwcyuvuuKQfo5")
...
Note that you will need also to install the **tweetscores** and the development version of **streamR** package from GitHub.  You can do this using this code:
```{r, eval = FALSE}
